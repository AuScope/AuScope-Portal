...
public class TestMineralOccurrenceFilter extends PortalTestClass {
    ...
    public void testWithNameAndMinimumOreAmount() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc,
                "/descendant::ogc:PropertyIsGreaterThanOrEqualTo/ogc:Literal", new String[] {"1234567"}, 2);
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsEqualTo/ogc:Literal",
                new String[] {commodityName, "urn:ogc:def:uom:UCUM:t"}, 4);
    }
    ...
    public void testReserveMinimumOreAmount() throws Exception {
        ...
        Document doc = AbstractFilterTestUtilities.parsefilterStringXML(filter);
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc,
                "/descendant::ogc:PropertyIsGreaterThanOrEqualTo/ogc:Literal", new String[] {"2000000"}, 1);
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsEqualTo/ogc:Literal",
                new String[] {"urn:ogc:def:uom:UCUM:t"}, 1);
    }
    ...
    public void testAnyMinimumOreAmount() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc,
                "/descendant::ogc:PropertyIsGreaterThanOrEqualTo/ogc:Literal", new String[] {"1000000"}, 2);
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsEqualTo/ogc:Literal",
                new String[] {"urn:ogc:def:uom:UCUM:t"}, 2);
    }
    ...
    public void testResourceMinimumCommodityAmount() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsEqualTo/ogc:Literal",
                new String[] {"urn:ogc:def:uom:UCUM:t", "6000000"}, 2);
    }
    ...
    public void testAnyMinimumCommodityAmount() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsEqualTo/ogc:Literal",
                new String[] {"urn:ogc:def:uom:UCUM:t", "7000000"}, 4);
    }
    ...
    public void testMatchCaseDefault() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsEqualTo/@matchCase",
                new String[] {"false"}, 1);
    }
