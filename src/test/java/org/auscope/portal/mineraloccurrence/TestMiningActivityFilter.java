...
/**
 * User: Mathew Wyatt Date: 25/03/2009 Time: 9:07:20 AM
 */
public class TestMiningActivityFilter extends PortalTestClass {
    ...
    public void testAssociatedMine() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsLike/ogc:PropertyName",
                new String[] {"er:specification/er:Mine/er:relatedActivity/er:MiningActivity/gml:name",
                        "er:specification/er:Mine/er:mineName/er:MineName/er:mineName"}, 2);
    ...
    public void testAssociatedMineDateRange() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc,
                "/descendant::ogc:PropertyIsGreaterThanOrEqualTo/ogc:Literal", new String[] {"01/JAN/1870"}, 1);
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc,
                "/descendant::ogc:PropertyIsLessThanOrEqualTo/ogc:Literal", new String[] {"31/DEC/1885"}, 1);
    }
    ...
    public void testAssociatedMineDateRangeOre() throws Exception {
        ...
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsGreaterThan/ogc:Literal",
                new String[] {"28"}, 1);
    }
    ...
    public void testAssociatedMineDateRangeProducedMaterial() throws Exception {
        ...
        AbstractFilterTestUtilities
                .runNodeSetValueCheck(
                        doc,
                        "/descendant::ogc:PropertyIsEqualTo/ogc:PropertyName",
                        new String[] {"er:specification/er:Mine/er:relatedActivity/er:MiningActivity/er:producedMaterial/er:Product/er:productName/gsml:CGI_TermValue/gsml:value"},
                        1);
        AbstractFilterTestUtilities.runNodeSetValueCheck(doc, "/descendant::ogc:PropertyIsEqualTo/ogc:Literal",
                new String[] {"Gold"}, 1);
    ...
    public void testAssociatedMineDateRangeCutOffGrade() throws Exception {
        ...
        MiningActivityFilter miningActivityFilter =
                new MiningActivityFilter("urn:cgi:feature:GSV:Mine:361068", "01/JAN/1870", "31/DEC/1885", "", "",
                        "10.14", "");
