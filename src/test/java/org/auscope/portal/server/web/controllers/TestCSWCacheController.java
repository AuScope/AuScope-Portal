...
public class TestCSWCacheController extends PortalTestClass {
    ...
    /**
     * Tests that the underlying services are called correctly and the response is transformed into an appropriate format.
     */
    @Test
    public void testGetKeywords() {
        ...
        expectedKeywords.put("keyword1",
                new HashSet<CSWRecord>(Arrays.asList(new CSWRecord("c"), new CSWRecord("b"), new CSWRecord("a"))));
