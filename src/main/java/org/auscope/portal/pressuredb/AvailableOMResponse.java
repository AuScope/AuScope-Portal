...
public class AvailableOMResponse implements Serializable {
    ...
    /**
     * @param obsTemperature
     *            the obsTemperature to set
     */
    ...
    /**
     * @param obsPressureData
     *            the obsPressureData to set
     */
