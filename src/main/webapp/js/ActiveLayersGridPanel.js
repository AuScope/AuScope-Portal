 ...
 */
ActiveLayersGridPanel = Ext.extend(Ext.grid.GridPanel, {
    layerSelectionHandler : null,
    layerMoveHandler : null,
    layerRemoveHandler : null,
    layerVisibilityHandler : null,
    layerStopRequest : null,

    constructor : function(id, title, description, activeLayersStore, layerSelectionHandler, layerMoveHandler, layerRemoveHandler, layerStopRequest, layerVisibilityHandler) {
        ...
        var activeLayersPanelCheckColumn = {
            xtype : 'checkcolumn',
            header: "Visible",
            dataIndex: 'layerVisible',
            width: 30,
            listeners : {
                checkchange : function(checkCol, rowIndex, checked) {
                    var alr = activeLayersStore.getActiveLayerAt(rowIndex);
                    layerVisibilityHandler(alr,checked,true);
                }
            }
        };

        var activeLayersPanelExpander = {
                ptype : 'rowexpander',
        ...
        ActiveLayersGridPanel.superclass.constructor.call(this, {
            plugins: [activeLayersPanelExpander],
            id : id,
            stripeRows: true,
