...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__openlayermap_olmap_component__ = __webpack_require__("../../../../../src/app/openlayermap/olmap.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__layerpanel_infopanel_openlayermappreview_olmap_preview_component__ = __webpack_require__("../../../../../src/app/layerpanel/infopanel/openlayermappreview/olmap.preview.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__layerpanel_layerpanel_component__ = __webpack_require__("../../../../../src/app/layerpanel/layerpanel.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__layerpanel_filterpanel_filterpanel_component__ = __webpack_require__("../../../../../src/app/layerpanel/filterpanel/filterpanel.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__layerpanel_downloadpanel_downloadpanel_component__ = __webpack_require__("../../../../../src/app/layerpanel/downloadpanel/downloadpanel.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__layerpanel_infopanel_infopanel_component__ = __webpack_require__("../../../../../src/app/layerpanel/infopanel/infopanel.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__toppanel_renderstatus_renderstatus_component__ = __webpack_require__("../../../../../src/app/toppanel/renderstatus/renderstatus.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__portal_core_ui_portal_core_module__ = __webpack_require__("../../../../../src/app/portal-core-ui/portal-core.module.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_5__openlayermap_olmap_component__["a" /* OlMapComponent */],
            __WEBPACK_IMPORTED_MODULE_6__layerpanel_infopanel_openlayermappreview_olmap_preview_component__["a" /* OlMapPreviewComponent */],
            __WEBPACK_IMPORTED_MODULE_7__layerpanel_layerpanel_component__["a" /* LayerPanelComponent */],
            __WEBPACK_IMPORTED_MODULE_8__layerpanel_filterpanel_filterpanel_component__["a" /* FilterPanelComponent */],
            __WEBPACK_IMPORTED_MODULE_9__layerpanel_downloadpanel_downloadpanel_component__["a" /* DownloadPanelComponent */],
            __WEBPACK_IMPORTED_MODULE_11__toppanel_renderstatus_renderstatus_component__["a" /* NgbdModalStatusReportComponent */],
            __WEBPACK_IMPORTED_MODULE_10__layerpanel_infopanel_infopanel_component__["a" /* InfoPanelComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_platform_browser__["a" /* BrowserModule */],
            __WEBPACK_IMPORTED_MODULE_4__angular_forms__["a" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClientModule */],
            __WEBPACK_IMPORTED_MODULE_12__portal_core_ui_portal_core_module__["a" /* PortalCoreModule */],
            __WEBPACK_IMPORTED_MODULE_3_ngx_bootstrap_modal__["a" /* ModalModule */].forRoot()
        ],
        entryComponents: [__WEBPACK_IMPORTED_MODULE_11__toppanel_renderstatus_renderstatus_component__["a" /* NgbdModalStatusReportComponent */]],
        bootstrap: [__WEBPACK_IMPORTED_MODULE_5__openlayermap_olmap_component__["a" /* OlMapComponent */], __WEBPACK_IMPORTED_MODULE_7__layerpanel_layerpanel_component__["a" /* LayerPanelComponent */]]
    })
], AppModule);
...
module.exports = "<div class=\"filter-form\">\r\n\t<div class=\"form-group\">\r\n\t\t<button type=\"button\" class=\"btn btn-purple\" (click)=\"drawBound()\">Select Bounds</button>\r\n\t</div>\r\n</div>"
...
var DownloadPanelComponent = (function () {
    function DownloadPanelComponent(layerHandlerService) {
...
DownloadPanelComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__portal_core_ui_service_cswrecords_layer_handler_service__["a" /* LayerHandlerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__portal_core_ui_service_cswrecords_layer_handler_service__["a" /* LayerHandlerService */]) === "function" && _b || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__portal_core_ui_service_wms_legend_service__ = __webpack_require__("../../../../../src/app/portal-core-ui/service/wms/legend.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__portal_core_ui_utility_utilities_service__ = __webpack_require__("../../../../../src/app/portal-core-ui/utility/utilities.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__openlayermappreview_olmap_preview_component__ = __webpack_require__("../../../../../src/app/layerpanel/infopanel/openlayermappreview/olmap.preview.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ol_proj__ = __webpack_require__("../../../../ol/proj.js");
...
var InfoPanelComponent = (function () {
    function InfoPanelComponent(legendService) {
    ...
    InfoPanelComponent.prototype.ngOnChanges = function (changes) {
        ...
        if (changes.expanded.currentValue === true && changes.expanded.previousValue === false) {
            ...
            if (this.layer.proxyStyleUrl && this.layer.proxyStyleUrl.length > 0) {
                this.legendService.getLegendStyle(this.layer.proxyStyleUrl).subscribe(function (response) {
                    if (response) {
                        ...
                        for (var i = 0; i < me_1.cswRecords.length; i++) {
                            var onlineResources = me_1.cswRecords[i].onlineResources;
                            for (var j = 0; j < onlineResources.length; j++) {
                                if (onlineResources[j].type === 'WMS') {
                                    ...
                                    me_1.legends[me_1.cswRecords[i].adminArea] = __WEBPACK_IMPORTED_MODULE_6__portal_core_ui_utility_utilities_service__["a" /* UtilitiesService */].addUrlParameters(onlineResources[j].url, params);
                                }
                            }
                        }
                    }
                ...
                for (var i = 0; i < this.cswRecords.length; i++) {
                    var onlineResources = this.cswRecords[i].onlineResources;
                    for (var j = 0; j < onlineResources.length; j++) {
                        if (onlineResources[j].type === 'WMS') {
                            var params = 'REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&HEIGHT=25&BGCOLOR=0xFFFFFF'
                                + '&LAYER=' + onlineResources[j].name + '&LAYERS=' + onlineResources[j].name + '&WIDTH=188';
                            this.legends[this.cswRecords[i].adminArea] = __WEBPACK_IMPORTED_MODULE_6__portal_core_ui_utility_utilities_service__["a" /* UtilitiesService */].addUrlParameters(onlineResources[j].url, params);
                        }
                    }
                }
            }
            ...
            for (var i = 0; i < this.cswRecords.length; i++) {
                ...
                if (bbox !== undefined && (bbox.westBoundLongitude !== 0 || bbox.northBoundLatitude !== 0 || bbox.eastBoundLongitude !== 0 || bbox.southBoundLatitude !== 0)
                    ...
                    bboxPolygonArr[key] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__turf_helpers__["featureCollection"])([__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__turf_helpers__["polygon"])([[
                                __WEBPACK_IMPORTED_MODULE_8_ol_proj__["a" /* default */].fromLonLat([bbox.westBoundLongitude, bbox.northBoundLatitude]),
                                __WEBPACK_IMPORTED_MODULE_8_ol_proj__["a" /* default */].fromLonLat([bbox.westBoundLongitude, bbox.southBoundLatitude]),
                                __WEBPACK_IMPORTED_MODULE_8_ol_proj__["a" /* default */].fromLonLat([bbox.eastBoundLongitude, bbox.southBoundLatitude]),
                                __WEBPACK_IMPORTED_MODULE_8_ol_proj__["a" /* default */].fromLonLat([bbox.eastBoundLongitude, bbox.northBoundLatitude]),
                                __WEBPACK_IMPORTED_MODULE_8_ol_proj__["a" /* default */].fromLonLat([bbox.westBoundLongitude, bbox.northBoundLatitude])
                            ]])]);
                ...
                for (var j = 0; j < onlineResources.length; j++) {
                    if (onlineResources[j].type === 'WMS') {
                        ...
                        this.wmsUrls[this.cswRecords[i].adminArea] = __WEBPACK_IMPORTED_MODULE_6__portal_core_ui_utility_utilities_service__["a" /* UtilitiesService */].addUrlParameters(onlineResources[j].url, params);
                    }
                }
            }
            ...
            if (reCentrePt !== {}) {
                ...
                this.previewMap.setupBBoxes(__WEBPACK_IMPORTED_MODULE_8_ol_proj__["a" /* default */].fromLonLat([reCentrePt.longitude, reCentrePt.latitude]), bboxPolygonArr);
            }
        }
    };
    /**
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_7__openlayermappreview_olmap_preview_component__["a" /* OlMapPreviewComponent */]),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_7__openlayermappreview_olmap_preview_component__["a" /* OlMapPreviewComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__openlayermappreview_olmap_preview_component__["a" /* OlMapPreviewComponent */]) === "function" && _b || Object)
...
InfoPanelComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__portal_core_ui_service_wms_legend_service__["a" /* LegendService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__portal_core_ui_service_wms_legend_service__["a" /* LegendService */]) === "function" && _c || Object])
], InfoPanelComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__service_wms_ol_wms_service__ = __webpack_require__("../../../../../src/app/portal-core-ui/service/wms/ol-wms.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__service_wfs_ol_wfs_service__ = __webpack_require__("../../../../../src/app/portal-core-ui/service/wfs/ol-wfs.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utility_gmlparser_service__ = __webpack_require__("../../../../../src/app/portal-core-ui/utility/gmlparser.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__service_wms_legend_service__ = __webpack_require__("../../../../../src/app/portal-core-ui/service/wms/legend.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__uiutilities_imgloading_directive__ = __webpack_require__("../../../../../src/app/portal-core-ui/uiutilities/imgloading.directive.ts");
...
PortalCoreModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__uiutilities_imgloading_directive__["a" /* ImgLoadingDirective */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClientModule */]
        ],
        exports: [__WEBPACK_IMPORTED_MODULE_2__uiutilities_pipes__["a" /* KeysPipe */], __WEBPACK_IMPORTED_MODULE_12__uiutilities_imgloading_directive__["a" /* ImgLoadingDirective */]],
        providers: [__WEBPACK_IMPORTED_MODULE_3__service_cswrecords_layer_handler_service__["a" /* LayerHandlerService */],
            ...
            __WEBPACK_IMPORTED_MODULE_8__service_wms_ol_wms_service__["a" /* OlWMSService */],
            __WEBPACK_IMPORTED_MODULE_5__service_openlayermap_ol_map_object__["a" /* OlMapObject */],
            __WEBPACK_IMPORTED_MODULE_9__service_wfs_ol_wfs_service__["a" /* OlWFSService */],
            __WEBPACK_IMPORTED_MODULE_10__utility_gmlparser_service__["a" /* GMLParserService */],
            ...
            __WEBPACK_IMPORTED_MODULE_11__service_wms_legend_service__["a" /* LegendService */],
            __WEBPACK_IMPORTED_MODULE_12__uiutilities_imgloading_directive__["a" /* ImgLoadingDirective */]
        ]
    }),
...
KeysPipe = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* Pipe */])({ name: 'getKey' })
], KeysPipe);
